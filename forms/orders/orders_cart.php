<div data-role="cart">
	 <div class="cart-table">
			...
			<div class="col-xs-12 actions"> 
				<div class="col-sm-4 col-xs-12 text-center"><a href="/" class="btn btn-primary">Продолжить</a></div>
				<div class="col-sm-4 col-xs-12 text-center"><a href="#" class="btn btn-success" data-toggle="modal" data-target="#modalOrder">Оформить</a></div>
				<div class="col-sm-4 col-xs-12 text-center"><a href="#" class="btn btn-danger cart-clear">Очистить</a></div>
			</div>
	</div>
