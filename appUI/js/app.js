...
var App = function() {
            ...
            if (themeColorCke) {
                if (themeColorCke === 'default') {
                    ...
                    if (themeLink.length) {
                        ...
                        $('link[href="/engine/appUI/css/themes.css"]')
    ...
    $(document).delegate("a,li","click",function(){
		if (!$(this).find("#sidebar-toggle-full").length && $("#sidebar-toggle-full").is(":visible")) {
			if ($(".sidebar-visible-lg-full").hasClass("sidebar-visible-xs")) {
				App.sidebar('toggle-sidebar');this.blur();
			}
		}
		if ($(".sidebar-visible-lg-mini .sidebar-nav-menu.open").length && !$(this).hasClass("sidebar-nav-menu open")) {
			$(".sidebar-visible-lg-mini .sidebar-nav-menu.open").removeClass("open");
		}
	});
